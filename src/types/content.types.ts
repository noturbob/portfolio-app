...
export type Person = {
  ...
  /** Email address */
  email: string;
  /** IANA time zone location, used for the clock */
  location: IANATimeZone;
  /** Place name shown to visitors; falls back to `location` */
  city?: string;
  /** Languages spoken */
  languages?: string[];
  /**
...
export interface Gallery extends BasePageConfig {
  ...
  images: Array<{
    ...
    orientation: string;
    /** Optional exact aspect ratio (e.g. "3024 / 4032"), overrides orientation */
    aspectRatio?: string;
    /** Optional short title shown under the image */
    caption?: string;
    /** Optional link shown under the caption, e.g. the full article */
